...
export function HowItWorks() {
  return (
    <section id="how" className="bg-gradient-to-b from-bg via-bg-raised to-bg border-y border-border py-10 px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="max-w-xl mx-auto text-center mb-12">
          ...
          <p className="text-base font-plus text-text-secondary mt-2 leading-relaxed">
            ...
            return (
              ...
              >
                ...
                <div className="flex items-center justify-between mb-5">
                  <div className="w-10 h-10 rounded-lg bg-bg border border-border flex items-center justify-center text-brass">
                    <Icon className="w-5 h-5" strokeWidth={1.75} />
                  </div>
                  <span className="font-plus text-xs font-medium text-text-secondary bg-bg px-2.5 py-1 rounded border border-border">
                    {step.number}
                  </span>
                </div>
                ...
                <p className="text-sm font-plus text-text-secondary leading-relaxed">
                  {step.description}
                </p>
              </div>
            );
