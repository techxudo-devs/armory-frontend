...
const inputClass =
  'w-full rounded-xl border border-[#23272D] bg-[#0F1422] px-3.5 py-2.5 text-sm text-[#F2F3F5] placeholder-[#5C636D] outline-none transition-colors focus:border-[#6667DD] focus:ring-2 focus:ring-[#6667DD]/20'
    ...
    <div className="min-h-screen bg-background p-0">
      ...
      <div className="w-full">
        <form
          ...
          className="space-y-8 rounded-2xl border border-[#1F293D] bg-gradient-to-b from-[#151A2A] to-[#0F1422] p-6 shadow-xl shadow-black/20"
        >
          {/* Basic Info */}
          <div>
            <h2 className="mb-4 flex items-center gap-2 text-sm font-semibold uppercase tracking-wider text-[#8B93A7]">
            ...
            <div className="grid grid-cols-1 xl:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <label
                  htmlFor="prizeImage"
                  className="flex cursor-pointer items-center gap-3 rounded-xl border border-dashed border-[#23272D] bg-[#0F1422] px-3.5 py-3 text-sm text-[#9AA0AA] transition-colors hover:border-[#6667DD] hover:text-[#A5B4FC]"
                >
